        ...
        setContent {
            ...
            balansappTheme {
                ...
                NavHost(
                    ...
                    startDestination = if ( (loginViewModel.user?.role ?: "USER") == "ADMIN" ) Screen.ExerciseAdmin.route  else Screen.Home.route
                ) {
...
//****************************      WIDOKI ADMINA *************************************************
                    ...
                    composable(Screen.ExerciseAdmin.route) { ExerciseAdminScreen(
                        navController = navController,
                        treningViewModel =treningViewModel,
