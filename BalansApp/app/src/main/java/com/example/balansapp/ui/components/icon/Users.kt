...
val FontAwesomeUsers: ImageVector
    get() {
        if (_FontAwesomeUsers != null) return _FontAwesomeUsers!!

        _FontAwesomeUsers = ImageVector.Builder(
            name = "users",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 640f,
        ...
        return _FontAwesomeUsers!!
    }

private var _FontAwesomeUsers: ImageVector? = null
