package com.example.balansapp.ui.components.icon
...
val MaterialSymbolsBriefcase_meal: ImageVector
    get() {
        if (_MaterialSymbolsBriefcase_meal != null) return _MaterialSymbolsBriefcase_meal!!

        _MaterialSymbolsBriefcase_meal = ImageVector.Builder(
            name = "briefcase_meal",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
        ...
        return _MaterialSymbolsBriefcase_meal!!
    }

private var _MaterialSymbolsBriefcase_meal: ImageVector? = null
